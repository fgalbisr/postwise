...
import { Facebook, CheckCircle, AlertCircle, BarChart3 } from "lucide-react";
import { toast } from "sonner";

export default function MetaAdsMock() {
  ...
  const connectMock = async () => {
    ...
    try {
      ...
      setIsConnected(true);
      toast.success("Conexión simulada exitosa con Meta Ads");
    } catch (error) {
  ...
  return (
    <div className="bg-white p-6 rounded-2xl shadow-card">
      <div className="flex items-center space-x-2 mb-6">
        ...
        <h3 className="text-xl font-bold text-gray-900">Meta Ads - Modo Demo</h3>
      </div>
      ...
      {isConnected ? (
        <div className="space-y-4">
          <div className="flex items-center space-x-3 p-4 bg-blue-50 rounded-lg">
            ...
            <div>
              <p className="font-medium text-blue-900">Meta Ads Conectado (Demo)</p>
              <p className="text-sm text-blue-700">Sincronización simulada activa</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
            ...
            <div className="bg-purple-50 p-4 rounded-lg">
              ...
              <p className="text-2xl font-bold text-purple-900">2.8x</p>
            </div>
          </div>
          ...
          <div className="p-4 bg-blue-50 rounded-lg">
            <div className="flex items-start space-x-3">
              ...
              <div className="text-sm text-blue-800">
                <p className="font-medium mb-2">Modo Demo - Meta Ads</p>
                <p className="mb-2">
                  Estás usando datos de prueba simulados. Para conectar con tu cuenta real de Meta Ads:
                </p>
                <ol className="list-decimal list-inside space-y-1">
                  <li>Ve a Facebook Business Manager</li>
                  <li>Configura Meta Marketing API</li>
